...
if not st.session_state.logged_in:
    ...
    if page == "Charger les données":
        ...
        if metadata:
            ...
            if st.button("Voir les fichiers"):
                selected_description = st.selectbox("Sélectionnez une description de fichier", df_metadata['description'])
                if selected_description:
                    ...
                    st.write(f"Affichage des données pour le fichier : {selected_file_id}")
        ...
        if metadata:
            ...
            selected_description_author = st.selectbox("Sélectionnez la description et l'auteur du fichier", descriptions_authors)
