...
#             if option == 'Migrations internes au Burkina Faso':
...
if file_option == 'Télécharger un nouveau fichier':
    ...
    if uploaded_file is not None:
        ...
        if data is not None:
            ...
            #     ('Carte', 'Graphique', 'Diagramme en bâtons', 'Diagramme circulaire')
            # )
    ...
    if selected_file:
        ...
        if data is not None:
            ...
            # st.title('Menu de Navigation Avancé')

            selected = option_menu(
                menu_title=None,  # Titre du menu, si None, pas de titre
                options=["Tabulaire", "Carte", "Graphique", "circulaire", "Histogramme", "Nuage Points"],  # Options du menu
                ...
                orientation="horizontal"  # Orientation du menu
            )
