...
menu_options = ["Welcome dashboard", "Consulter les données", "Consulter les métadonnées"]
...
if keycloak.authenticated:
    with st.sidebar:
        choix = option_menu(
            "Menu", 
            menu_options,
            icons=["house", "cloud-upload", "pencil", "trash", "table", "info-circle"] if keycloak.authenticated else ["house", "table", "info-circle"],
            menu_icon="cast",
            default_index=0,
            orientation='vertical'
        )
